import os
import time
from Image_HighlightDifference_PIL import Image_HighlightDifference_PIL
from Image_HighlightDifference_WatchUI import Image_HighlightDifference_WatchUI
